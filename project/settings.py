...
ALLOWED_HOSTS = ['group44-web-apps-ec22668.apps.a.comp-teach.qmul.ac.uk', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Ensure this directory contains your templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
